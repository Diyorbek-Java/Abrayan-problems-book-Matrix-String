...
public class Solution74 {
    public static void main(String[] args) {
        ...
        double[][] updatedMatrix = replaceLocalMinimums(matrix);
    ...
    public static double[][] replaceLocalMinimums(double[][] matrix) {
        int m = matrix.length;
    ...
    public static boolean isLocalMinimum(double[][] matrix, int row, int col) {
