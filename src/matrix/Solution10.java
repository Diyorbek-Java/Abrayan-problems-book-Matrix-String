...
public class Solution10 {
    public static void main(String[] args) {
        ...
        System.out.println("""
                 An M × N matrix of real numbers is given. Output elements of its rows with even order numbers (2, 4, …).
        ...
        System.out.println("Elements of columns with odd order numbers:");
        for (int j = 0; j < N; j += 2) {
            for (int i = 0; i < M; i++) {
