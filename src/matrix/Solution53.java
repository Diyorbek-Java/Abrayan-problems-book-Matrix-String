...
public class Solution53 {
    public static void main(String[] args) {
        ...
        int lastPositiveColumnIndex = findLastPositiveColumn(matrix);

        if (lastPositiveColumnIndex != -1) {
            exchangeColumns(matrix,0,lastPositiveColumnIndex);
        }
    ...
    public static int findLastPositiveColumn(double[][] matrix) {
